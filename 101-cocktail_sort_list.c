 ...
 * @list: ptr to the top of a doubly-linked list of integers
 * @tail: ptr to the end of the doubly-linked list
...
/**
 * cocktail_sort_list - srt a listint_t doubly-linked list of integers in
 *                      ascending order using the cocktail shaker algorithm.
 * @list: ptr to the top of a listint_t doubly-linked list.
 */
void cocktail_sort_list(listint_t **list)
{
